...
Gem::Specification.new do |spec|
  spec.name = "kettle-drift"
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/kettle/drift/version.rb", mod) }::Kettle::Drift::Version::VERSION
  ...
  spec.homepage = "https://github.com/kettle-dev/kettle-drift"
  ...
  spec.metadata["homepage_uri"] = "https://kettle-drift.galtzo.com"
  ...
  # kettle-jem:freeze
  # To retain chunks of comments & code during kettle-drift templating:
  # Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
  ...
  # The 'git' gem is optional; kettle-drift falls back to shelling out to `git` if it is not present.
